...
class ViewController: UIViewController {
    ...
    // 스토리보드에서 보조에디터로 드레그하여 연결
    @IBOutlet var uiTitle01: UILabel!
    
    // 연결할 객체를 선택 후, 커넥션 인스펙터에서 보조에디터로 드레그하여 연결
    @IBOutlet var uiTitle02: UILabel!
    
    // 보조에디터에 연결하려는 프로퍼티를 코딩하고 스토리보드로 드레그하여 연결
    @IBOutlet var uiTitle03: UILabel!
    
    // 보조에디터에 연결하려는 프로퍼티를 코딩한 후, viewController 클래스 내부의 커넥션 인스펙터 탭에서 스토리보드로 드레그하여 연결
    @IBOutlet var uiTitle04: UILabel!
    
    // 문서 개요창에서 대응하는 객체를 찾아 보조에디터로 드레그하여 연결
